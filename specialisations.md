...
### The Grind
Every 3 times you upgrade a specific affix on you, it gains 3 additional upgrade points.
...
### Cross-Contamination
Whenever you choose a new glyph path, you may also choose one of the path options you didn't choose. 3 random upgrade tiers from this other path are shown to you, and you may choose one of them to apply to your new glyph path. Additionally, for each glyph path you have already started, you immediately do this with two random other paths.
...
### Potent Corruption
You gain glyphic damage equal to your level, and you may apply your glyphic damage bonus as added damage to non-damaging glyphic powers.
